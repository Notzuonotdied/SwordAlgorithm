...
public class Demo31 {
    public static void main(String[] args) {
        System.out.println(Solution1.NumberOf1Between1AndN_Solution(13));
    }
    ...
    private static class Solution1 {
         ...
         *
         * 完美！归纳式看起来已经很规整了。 来一个更抽象的归纳，设i为计算1所在的位数，i=1表示计算个位数的1的个数，i=10表示计算十位数的1的个数等等。
         *
         *         k = n % (i * 10)
         ...
         *
         * 但是有一个地方值得我们注意的，就是代码的简洁性来看，有多个if-else不太好，能不能进一步简化呢？ 我们可以把后半段简化成这样，
         * 我们不去计算i * 2 - 1了，我们只需保证k - i + 1在[0, i]区间内就行了，最后后半段可以写成这样
         *
